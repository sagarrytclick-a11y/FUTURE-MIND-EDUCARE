...
const MdMsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-purple-50/40 to-gray-100">
      {/* TOP ANNOUNCEMENT STRIP */}
      <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-600 text-white py-3 px-4 text-center">
      ...
      {/* HERO SECTION */}
      <section className="relative overflow-hidden bg-gradient-to-br from-purple-950 via-purple-800 to-indigo-700 py-24 text-white">
        <div className="absolute top-0 left-0 h-72 w-72 rounded-lg bg-indigo-400/20 blur-3xl"></div>

        <div className="absolute bottom-0 right-0 h-72 w-72 rounded-lg bg-purple-400/20 blur-3xl"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-purple-100 leading-relaxed">
              Explore premier post-graduate medical colleges with complete
              details about fees, seats, rankings and NEET PG admissions.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-5 lg:items-center lg:justify-between">
            ...
            <div className="relative w-full lg:w-[350px]">
              ...
              <input
                ...
                className="w-full h-10 sm:h-14 rounded-lg sm:rounded-2xl border border-gray-200 bg-gray-50 pl-9 sm:pl-12 pr-4 outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
              />
            </div>
              ...
              <div className="p-3 sm:p-4 lg:p-6">
                ...
                <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4 lg:mb-6">
                  <div className="flex justify-between text-xs sm:text-sm">
                    ...
                    <span className="font-bold text-purple-700 text-xs sm:text-sm">{college.fees}</span>
                  </div>
                ...
                <div className="flex items-center gap-2 text-green-600 text-xs sm:text-sm font-bold mb-2 sm:mb-3 lg:mb-4">
                  ...
                  <span className="text-xs sm:text-sm">NMC APPROVED</span>
                </div>

                <Link
                  href={`/colleges/${college.name.toLowerCase().replace(/[^a-z0-9\s]/g, "").replace(/\s+/g, "-")}`}
                  className="w-full py-2 sm:py-3 rounded-xl bg-purple-600 text-white font-bold flex items-center justify-center gap-2 hover:bg-purple-700 transition-all text-sm sm:text-base"
                >
                  View Details
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 disabled:opacity-40 disabled:hover:bg-purple-600 disabled:cursor-not-allowed transition-all duration-200 shadow-sm text-sm"
                >
                    ...
                    return (
                      <button
                        ...
                        className={`w-9 h-9 sm:w-11 sm:h-11 shrink-0 flex items-center justify-center rounded-xl font-semibold transition-all duration-200 text-sm ${
                          isCurrent
                            ? "bg-purple-50 text-purple-600 border-2 border-purple-600 cursor-not-allowed"
        ...
        {/* CTA */}
        <div className="mt-24">
          <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-r from-purple-700 via-purple-800 to-indigo-700 p-12 shadow-2xl">
            ...
            <div className="relative z-10 text-center text-white max-w-3xl mx-auto">
              ...
              <p className="text-purple-100 text-lg leading-relaxed mb-10">
                ...
                documentation and direct guidance
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center">
                <Link
                  href="/contact"
                  className="bg-white text-purple-700 px-8 py-4 rounded-2xl font-bold hover:scale-105 transition-all"
                >
                  Get Free Counseling
                </Link>
